class Solution():
    def single_non_duplicate(self, nums: list) -> int:
        ...
        while(left<=right):
            ...
            if(count_less_or_equal > 0 and
               count_less_or_equal< len(nums)-1 and
               nums[count_less_or_equal] != nums[count_less_or_equal-1] and
               nums[count_less_or_equal] != nums[count_less_or_equal+1]):
                return nums[count_less_or_equal]
